 ...
 * GET /storage/objects/*
 *
 * Serve event images from PRIVATE_OBJECT_DIR.
 * Requires a valid JWT — any authenticated role (participant, supervisor, admin)
 * may view event images, since events are visible to all logged-in users.
 */
router.get(
