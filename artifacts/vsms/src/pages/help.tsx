...
const SECTIONS: { title: string; items: QA[]; roles?: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How do I set the medal thresholds? (Super Admin)", a: "Open Award Thresholds from the menu. You can set the Bronze / Silver / Gold hour targets globally, per organization, or per grade level — so younger grades can have lower targets. The most specific rule wins (grade + org, then org, then grade, then the global default). Leaderboards, reports, and the metrics chart all use these thresholds automatically." },
      { q: "Where can I see who changed what? (Super Admin)", a: "Open Audit Log from the menu. It records key actions — creating users, changing thresholds, deleting or reassigning events, and more — with who did it and when, so you have an accountability trail across all organizations." },
